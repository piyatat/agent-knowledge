...
- Stack (AAIF’s own split): AGENTS.md = project instructions; goose = agent runtime; MCP = tools/data; agentgateway = routing/policy/observability; A2A = peer discovery and task exchange.

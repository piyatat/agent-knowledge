...
Standing instructions are useful; **always-on walls of text** tax every turn. Keep a thin portable `AGENTS.md` (AAIF format — `agents-md-open-format`), scope Cursor `.mdc` rules with globs, and link out to deep docs (including this knowledge repo) instead of inlining manuals.

## Notes

- **`AGENTS.md`**: portable, plain markdown; nested copies apply under that directory; closest file wins. Good default cross-tool source of truth (`agents.md`).
...
- [Cursor Rules](https://cursor.com/docs/rules.md) — accessed 2026-08-31

...
- Sandbox agents: isolated workspace, manifest files, resumable sandbox sessions — use when the job is files/repos, not a chat turn. Also: MCP servers as tools, Sessions memory, Realtime/voice pipelines.

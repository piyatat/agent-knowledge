...
status: active
updated: 2026-08-28
when_to_use: Hosting or mirroring repos on Cursor Origin, using the origin CLI, or attaching Cloud Agents without a third-party SCM
---

## Summary

**Origin** is Cursor’s git forge (early beta, paid plans). Teams claim a codebase namespace at `cursor.com/codebase/{owner}/{repo}`, then create Origin-hosted repos or **mirror GitHub**. Cloud Agents can create and push to Origin without connecting GitHub first. Legacy Privacy Mode blocks enablement.

## Notes

- Access: Pro / Teams / Enterprise, staged rollout. Admins can disable Origin. Namespace is **not** renameable during beta — pick it carefully. Origin follows the Privacy Mode of the namespace owner (`cursor-privacy-mode`).
